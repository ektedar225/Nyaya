...
function getImageUrl(url) {
  ...
  // If it's a relative local image name, point it up to the root folder
  return '../' + url;
}
        ...
        <table>
          ...
          <tbody>
            ${CURRENT_ADVOCATES.map((a) => `
              <tr>
                <td><img class="thumb" src="${esc(getImageUrl(a.photo_url))}" alt=""></td>
      ...
      <div class="form-grid">
        ...
        <div class="field full">
          <label>Profile Photo</label>
           ${adv.photo_url ? `<img src="${esc(getImageUrl(adv.photo_url))}" class="img-preview">` : ''}
